    ...
    <footer id="lpp-footer">
        <div class="footer-container">
            ...
            <div class="footer-logo">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lpp-logo-white.png" alt="Lollipops Party Packages logo by Hershey/Qrtny">
            </div>
...
function lpp_enqueue_ballondesign_styles() {
    if (is_page_template('ballon-design.php')) {
        wp_enqueue_style(
            'ballondesign-styles',
            get_stylesheet_directory_uri() . '/ballondesign/ballon-design.css',
            [],
            '1.0.0'
        );
    }
}
add_action('wp_enqueue_scripts', 'lpp_enqueue_ballondesign_styles');


function lpp_enqueue_partyrentals_styles() {
    if (is_page_template('party-rentals.php')) {
        wp_enqueue_style(
            'partyrentals-styles',
            get_stylesheet_directory_uri() . '/partyrentals/party-rentals.css',
            [],
            '1.0.0'
        );
    }
}
add_action('wp_enqueue_scripts', 'lpp_enqueue_partyrentals_styles');

function lpp_enqueue_eventdecoration_styles() {
    if (is_page_template('event-decorations.php')) {
        wp_enqueue_style(
            'eventdecoration-styles',
            get_stylesheet_directory_uri() . '/eventdecoration/event-decoration.css',
            [],
            '1.0.0'
        );
    }
}
add_action('wp_enqueue_scripts', 'lpp_enqueue_eventdecoration_styles');
